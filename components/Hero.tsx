    ...
    <section className="mb-20">
      <div className="flex flex-col md:flex-row md:items-center xl:gap-2 md:gap-0">
        <h1 className="text-4xl md:text-5xl font-bold mb-6 flex items-center gap-2">
          <u className={font.className}>hi, i&apos;m Rajveer.</u>
        </h1>

        <LiveAge />
      </div>
      <p className="text-muted-foreground mb-4">
        20 &bull; engineer &bull; developer
      </p>
      ...
      <div className="mb-8">
        ...
        <p className="text-sm">
          <a href="https://github.com/rajveerbairagi" className="underline hover:text-muted-foreground transition">
            github
          </a>
          {" • "}
          <a href="https://www.linkedin.com/in/rajveerbairagi" className="underline hover:text-muted-foreground transition">
            linkedin
          </a>
          {" • "}
          <a href="https://x.com/rajveer_051" className="underline hover:text-muted-foreground transition">
            twitter
          </a>
        </p>
      </div>
      ...
      <div>
        <p className="text-sm">
          ...
          <a href="mailto:rajveerbairagi9@gmail.com" className="underline hover:text-muted-foreground transition">
            rajveerbairagi9@gmail.com
          </a>
        </p>
        <p className="text-sm">
